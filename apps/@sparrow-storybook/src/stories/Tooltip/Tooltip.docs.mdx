...
<Markdown>
  {`
| Size | Tooltip Height | Padding (X x Y) | Gap | Width Range | Corner Radius | Font Size | Description | Use Case |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Small | Hug | 12 x 4 px | 0px | 56 - 128 px | 4 px | label Row 2 paragraphs/sm-400 = 12px reg | Tooltips for buttons and icons should be concise and limited to a single line, while tooltips for truncated text can span up to a maximum of two lines to ensure simplicity. | For button, icon, truncated text, etc... |
| Medium | Hug | 12 x 8 px | 4px | 128 - 256 px | 6 px | heading Row 2 labels/sm-600 = 12px bold sub-heading paragraph/sm-400 = 12px reg | The medium tooltip contains a heading and subtext. The heading should be concise, fitting within a single line for clarity. The subtext can span multiple lines, allowing for more detailed information without exceeding a maximum of two lines to maintain readability. | For info message, hint message, etc... |
`}
</Markdown>
