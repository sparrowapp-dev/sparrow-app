...
export class CollectionService {
  ...
  public validateImportCollectionURL = async (url = "") => {
    return makeHttpRequestV2(
      url,
      "GET",
      '[{"key":"Accept-Encoding","value":"gzip, br","checked":true},{"key":"User-Agent","value":"SparrowAgent/v2","checked":true},{"key":"Connection","value":"keep-alive","checked":true},{"key":"Accept","value":"*/*","checked":true}]',
      "",
      "text/plain",
    );
  };
