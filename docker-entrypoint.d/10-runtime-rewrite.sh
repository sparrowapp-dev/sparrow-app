...
window.runtimeConfig = {
  ...
  VITE_WEB_OPENFEEDBACK_URL: "${VITE_WEB_OPENFEEDBACK_URL}",
  VITE_WEB_OPENFEEDBACK_BOARD_ID: "${VITE_WEB_OPENFEEDBACK_BOARD_ID}",
  ...
  VITE_WEB_OPENFEEDBACK_API: "${VITE_WEB_OPENFEEDBACK_API}",
