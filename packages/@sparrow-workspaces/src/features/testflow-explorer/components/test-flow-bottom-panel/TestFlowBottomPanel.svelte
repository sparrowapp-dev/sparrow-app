...
>
  ...
  >
    <!-- Request Pane -->
    <Pane minSize={60} size="60" class="position-relative bg-transparent">
        ...
        <div style="flex:1; overflow:auto; margin-top: 12px;" class="p-0">
          {#if requestNavigation === RequestSectionEnum.PARAMETERS}
            <RequestParameterTestFlow
              ...
              authParameter={{}}
              isBulkEditActive={selectedBlock?.data?.requestData?.state
    ...
    <!-- Response Pane -->
    <Pane minSize={30} size="40" class="position-relative bg-transparent">
