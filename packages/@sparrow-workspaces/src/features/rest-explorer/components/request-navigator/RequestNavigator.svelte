...
<div style="padding-bottom: 12px; position:relative;">
  {#if requestStateSection === RequestSectionEnum.HEADERS || requestStateSection === RequestSectionEnum.PARAMETERS || requestStateSection === RequestSectionEnum.REQUEST_BODY}
    <div
    ...
    >
      <button
        ...
        tabindex="0"
        on:click={async () => await generateMockData()}
      >
