<script lang="ts">
  ...
  import { profileTabIcon as profile } from "@deprecate/assets";
  import { profileHoveredIcon as hoveredProfile } from "@deprecate/assets";
  import { profileSelectedIcon as selectedProfile } from "@deprecate/assets";
