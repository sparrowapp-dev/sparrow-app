...
class InitAiRequestTab {
      ...
      property: {
        aiRequest: {
          ...
          state: {
            ...
            isAiRequestVariablesBulkEditActive: false,
          },
        },
      },
      path: {
  ...
  //     }
  // }
  public updateAiRequestVariables(_variables: KeyValueChecked[]) {
    if (_variables && this._tab.property.aiRequest) {
      this._tab.property.aiRequest.variables = _variables;
    }
  }
