export enum Events {
  ...
  CREATE_NEW_TEAM = "Create_New_Hub",
  Delete_Workspace = "Delete_Workspace",
  Leave_Team = "Leave_Hub",
  Workspace_Role_Changed = "Workspace_Role_Changed",
  Teams_Role_Changed = "Hubs_Role_Changed",
  Remove_User_Team = "Remove_User_Hub",
  Remove_User_Workspace = "Remove_User_Workspace",
  Team_Ownership_Transferred = "Hub_Ownership_Transferred",
  Invite_To_Team_Admin = "Invite_To_Hub_Admin",
  Invite_To_Team_Member = "Invite_To_Hub_Member",
  Create_New_Workspace_TopBar = "Create_New_Workspace_TopBar",
  Create_New_Workspace_TeamPage = "Create_New_Workspace_HubPage",
