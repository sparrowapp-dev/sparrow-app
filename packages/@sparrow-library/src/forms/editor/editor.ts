...
const testJsCompletions = (context: CompletionContext) => {
  ...
  return {
    ...
    options: [
      ...
      { label: "setTimeout", type: "function", info: "Set a timer", apply: "setTimeout()" },
      { label: "setInterval", type: "function", info: "Set interval timer", apply: "setInterval()" },
      { label: "clearTimeout", type: "function", info: "Clear a timer", apply: "clearTimeout()" },
      { label: "clearInterval", type: "function", info: "Clear interval timer", apply: "clearInterval()" },
      { label: "log", type: "function", info: "Log output", apply: "log()" },
      { label: "console", type: "namespace", info: "Console logging object" },
