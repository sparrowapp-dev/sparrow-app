<script lang="ts">
  ...
  let isWelcomeScreenPopup: boolean = false;
  const handleWelcomeScreenPopup = (flag) => {
    isWelcomeScreenPopup = flag;
  };
</script>

{#if isWelcomeScreenPopup}
  <WelcomeScreen onClick={handleWelcomeScreenPopup} />
{/if}
    ...
    >
      ...
      <div class="mb-3 mt-4">
        <button
          ...
          on:click={() => {
            handleWelcomeScreenPopup(validationErrors.isSuccessful);
          }}>Sign Up</button
        >
      </div>
