<script lang="ts">
  ...
  import FeedbackDefault from "@support/features/feedback-section/layout/FeedbackDefault.svelte";
  import FeedbackFilters from "@support/features/feedback-section/layout/FeedbackFilters.svelte";
  ...
  //   import UpdateDefault from "./UpdateDefault.svelte";
  // import Like from "@library/icons/Like.svelte";
...
<div class="container">
  <!-- <UpdateDefault /> -->
  <div>
    <p class="text-fs-20" style="font-weight:700;">My Acitvity</p>
