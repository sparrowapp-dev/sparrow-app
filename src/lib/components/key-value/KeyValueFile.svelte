<script lang="ts">
    ...
    $: {
        if(files){
            ...
            // console.log(data);
            // console.log((window.URL || window.webkitURL).createObjectURL(files[0]))
        }
    }
            ...
            >
              ...
              <div class="w-100 d-flex gap-2">
                ...
                <div class="flex-grow-1 w-100">
                  ...
                  /> -->
                  <div style="background-color: black; height: 26px;">
                        {#if !element.value}
                            <input type="file" bind:files id="formdata-file" style="display:none;"/>
                            <label for="formdata-file" style="width:100%; height:100%;">Choose File</label>
                        {:else} file name
                        {/if}
                  </div>
                </div>
